    ...
    private void idClickListner() {
        ...
        edtNewPassword.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus){
                    ((InputMethodManager) ResetPasswordActivity.this.getApplicationContext().getSystemService(Context.INPUT_METHOD_SERVICE)).showSoftInput(ResetPasswordActivity.this.edtNewPassword, 2);
