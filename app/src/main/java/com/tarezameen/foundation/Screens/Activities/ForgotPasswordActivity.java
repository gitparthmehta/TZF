    ...
    private void idClickListner() {
        ...
        edt_Email.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus){
                    ((InputMethodManager) ForgotPasswordActivity.this.getApplicationContext().getSystemService(Context.INPUT_METHOD_SERVICE)).showSoftInput(ForgotPasswordActivity.this.edt_Email, 2);
